...
LRESULT CALLBACK SettingsWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    switch (msg) {
        ...
        case WM_CREATE: {
            ...
            CreateWindowExA(0, "BUTTON", "Space During Jump", WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX, 36, 148, 200, 25, hwnd, (HMENU)305, GetModuleHandle(NULL), NULL);
            CreateWindowExA(0, "BUTTON", "Enabled", WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX, 36, 190, 100, 25, hwnd, (HMENU)306, GetModuleHandle(NULL), NULL);
            g_statusLabelJump = CreateWindowExA(0, "STATIC", "Super Jump: idle", WS_CHILD | WS_VISIBLE, 36, 228, 400, 20, hwnd, (HMENU)308, GetModuleHandle(NULL), NULL);
            ...
            CheckDlgButton(hwnd, 305, g_config.spaceDuringJump ? BST_CHECKED : BST_UNCHECKED);
        ...
        case WM_NOTIFY: {
            ...
            if (hdr->idFrom == 100 && hdr->code == TCN_SELCHANGE) {
                ...
                switch (tab) {
                    ...
                    case 3: for (int id : {302,303,305,306,308,1301}) ShowWindow(GetDlgItem(hwnd,id), SW_SHOW); break;
        ...
        case WM_COMMAND: {
            switch (LOWORD(wParam)) {
                ...
                case IDOK: {
                    ...
                    bool newSpaceDuringJump = (IsDlgButtonChecked(hwnd, 305) == BST_CHECKED);
                    ...
                    g_config.spaceDuringJump = newSpaceDuringJump;
