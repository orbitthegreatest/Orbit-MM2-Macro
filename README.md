...
Steps:
1. Enable the macro in the Speed glitch page
2. Enable/Disable "Hold mode" (toggle/hold)
...
3. Bind your hotkey
4. Go in MM2 and make sure you're on the menu where the Sit emote is at
5. Press your hotkey
